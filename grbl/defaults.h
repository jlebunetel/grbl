...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_X_ACCELERATION (5*10.0*60*60) // 5*10*60*60 mm/min^2 = 50 mm/sec^2
  #define DEFAULT_Y_ACCELERATION (5*10.0*60*60) // 5*10*60*60 mm/min^2 = 50 mm/sec^2
  #define DEFAULT_Z_ACCELERATION (10.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_X_MAX_TRAVEL 250.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Y_MAX_TRAVEL 225.0 // mm NOTE: Must be a positive value.
  ...
  #define DEFAULT_HOMING_DIR_MASK 3 // invert X and Y
